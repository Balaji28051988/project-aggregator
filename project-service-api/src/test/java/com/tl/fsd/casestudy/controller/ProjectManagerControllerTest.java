package com.tl.fsd.casestudy.controller;
...
import com.tl.fsd.casestudy.service.ProjectManagerService;
...
public class ProjectManagerControllerTest {
	...
	public void getProjectInfo_thenReturnJsonArray() throws Exception {
		...
		mvc.perform(get("/getprojectsdetail").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk())
	...
	public void getUserInfo_thenReturnJsonArray() throws Exception {
		...
		mvc.perform(get("/getusersdetails").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk())
	...
	public void getTaskInfo_thenReturnJsonArray() throws Exception {
		...
		mvc.perform(get("/gettasks/1").contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk())
	...
	public void getParentTaskInfo_thenReturnJsonArray() throws Exception {
		...
		mvc.perform(get("/getparenttasks/{projectId}", 1).contentType(MediaType.APPLICATION_JSON))
	...
	public void getParentTaskInfo_InvalidArgument() throws Exception {
		mvc.perform(MockMvcRequestBuilders.get("/getparenttasks/f").accept(MediaType.APPLICATION_JSON))
	...
	public void addOrUpdUser_updateUser() throws Exception {
		...
		mvc.perform(post("/updateusers").contentType(MediaType.APPLICATION_JSON)
	...
	public void updateProject_editProject() throws Exception {
		...
		mvc.perform(post("/updateprojects").contentType(MediaType.APPLICATION_JSON)
	...
	public void updateTask_editTask() throws Exception {
		...
		mvc.perform(post("/updatetasks").contentType(MediaType.APPLICATION_JSON)
	...
	public void deleteProject_Success() throws Exception {
		...
		mvc.perform(delete("/deleteprojects/{id}", 1).contentType(MediaType.APPLICATION_JSON))
				.andExpect(status().isOk());
	...
	public void deleteUser_Success() throws Exception {
		...
		mvc.perform(delete("/deleteusers/{id}", 1).contentType(MediaType.APPLICATION_JSON)).andExpect(status().isOk());
