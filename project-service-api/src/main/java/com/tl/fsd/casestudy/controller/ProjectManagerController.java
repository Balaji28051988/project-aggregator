...
public class ProjectManagerController {
	...
	@PostMapping(value = "/updateusers", headers = "Accept=application/json")
	...
	@PostMapping(value = "/updateprojects", headers = "Accept=application/json")
	...
	@PostMapping(value = "/updatetasks", headers = "Accept=application/json")
	...
	@GetMapping(value = "/getparenttasks/{projectid}", headers = "Accept=application/json")
	...
	@DeleteMapping(value = "/deleteusers/{id}", headers = "Accept=application/json")
	...
	@DeleteMapping(value = "/deleteprojects/{id}", headers = "Accept=application/json")
